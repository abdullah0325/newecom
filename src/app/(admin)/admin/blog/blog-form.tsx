...
export function BlogForm({
  ...
  return (
    <div className="p-8">
      ...
      <form
        onSubmit={onSubmit}
        className="grid gap-6 rounded-xl border border-[#C6A24A]/20 bg-white p-6"
      >
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <label className="block text-sm font-medium text-[#1E1F1C]">Category</label>
            <select
        ...
        <div>
          <label className="block text-sm font-medium text-[#1E1F1C]">Excerpt</label>
          <textarea
        ...
        <div className="rounded-lg border border-[#C6A24A]/20 bg-[#F6F1E7]/60 p-4">
          ...
          <div className="mt-3 grid gap-4 lg:grid-cols-2">
            <div>
              <label className="block text-sm font-medium text-[#1E1F1C]">SEO Title</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-[#1E1F1C]">SEO Description</label>
              <textarea
